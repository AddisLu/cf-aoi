...
| 案例 | 缺陷 | gpu_ms median |
|------|------|---------------|
| 001 乾淨, 32×32（預設） | 0 | **6.95** |
| 027 1缺陷, 32×32（預設） | 1 | **7.37**（100 iters 時 7.40） |
| 027 1缺陷, 16×16 | 1 | 7.41 |
| 027 中負載 DTH0.85, 32×32 | 10000（觸頂） | 8.11 |
| 027 重負載 DTH0.95, 32×32 | 10000 | 14.34 |
| 027 重負載 DTH0.95, 16×16 | 10000 | 14.19 |

### 4.1 block_dim 16×16 vs 32×32 → 無差異

7.37 vs 7.41（1 缺陷）、14.34 vs 14.19（爆量）。RAG_TRAINING.md §5.2 建議生產用 16×16，
**在 GB10 上對此 kernel 無意義，不需為它改 ini**。
